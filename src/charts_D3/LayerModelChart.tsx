...
const styles = {
  container: {
    ...
    borderRadius: '12px',
    padding: '24px',
    paddingBottom: '74px', // Added 50px extra for dropdown expansion
    maxHeight: 'none', // Removed height constraint to allow full expansion
    overflowY: 'visible' as const, // Changed from 'auto' to allow full visibility
  },
  header: {
    marginBottom: '20px',
