...
const defaultData = {
  services: [
    ...
    { id: 'order-service', name: 'Order Service', icon: 'F', type: 'core', x: 1, y: 2 },
    { id: 'inventory-service', name: 'Inventory', icon: '▦', type: 'core', x: 2, y: 0 },
    { id: 'payment-service', name: 'Payment', icon: '04', type: 'core', x: 2, y: 1 },
    { id: 'notification-service', name: 'Notification', icon: '+', type: 'core', x: 2, y: 2 },
    { id: 'search-service', name: 'Search', icon: '02', type: 'support', x: 3, y: 0.5 },
  ...
  patterns: [
    ...
    { name: 'Service Discovery', icon: '02', services: ['all'] },
    { name: 'Load Balancing', icon: '+', services: ['api-gateway'] },
  ],
  infrastructure: {
    serviceMesh: 'Istio',
    discovery: 'Consul',
  ...
  return (
    <div style={{ width: '100%' }}>
      ...
      <div style={{ 
        ...
        {[
          { label: 'Service Mesh', value: data.infrastructure.serviceMesh, icon: '+' },
          { label: 'Discovery', value: data.infrastructure.discovery, icon: '02' },
