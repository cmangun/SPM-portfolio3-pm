...
const FDEFooter: React.FC<FooterProps> = ({ bgColor = "#1a1a1a", className = "", Zindex = "" }) => {
    return (
        <footer style={{ backgroundColor: bgColor, padding: '60px 0 40px' }}>
